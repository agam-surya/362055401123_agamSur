...
import 'sign_with_facebook.dart';
      ...
      body: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            signUp_button(context, 'https://e7.pngegg.com/pngimages/483/841/png-clipart-email-email.png', Colors.white, 'Sign with Email', SignWithEmail()),
            SizedBox(
              height: 30,
            ),
